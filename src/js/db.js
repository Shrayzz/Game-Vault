...
function init(con) {
    ...
    con.query("INSERT INTO accounts (id, username, password, email) VALUES(1, 'test', 'test', 'test@test.com');")
}

// TESTS
// const con = connect('localhost', 'root', 'root');
// init(con);
// con.query("INSERT INTO accounts (id, username, password, email) VALUES(4, 'fef', 'fed', 'fefge');")
// disconnect(con);
